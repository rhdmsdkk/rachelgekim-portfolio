    ...
    <section className="home" id="home">
      ...
      <div className="home__description_container">
        ...
        <div className="home__description__lg">
          ...
          <br />
          <p className="home__description">
            I love all things coding & game development! This is the place to
            see what I&apos;ve been building.
          </p>
        </div>
        <div className="home__description__sm">
          <p className="home__description">
            I&apos;m a computer science student @ Georgia Tech with threads in
            Media and Intelligence. I love all things coding & game development!
            This is the place to see what I&apos;ve been building.
          </p>
        </div>
      </div>
